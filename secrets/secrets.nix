let
  Mending = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGGrz9BTF/SPv3/ioaUv6pMt13pPz6w3qOZA2C8+cdlS";
...
in
{
  ...
  "Unbreaking/vaultwarden-admin-token.age".publicKeys = [ Unbreaking ];
  "Unbreaking/vaultwarden-push-id.age".publicKeys = [ Unbreaking ];
  "Unbreaking/vaultwarden-push-key.age".publicKeys = [ Unbreaking ];

  "Unbreaking/smtp-username.age".publicKeys = [ Unbreaking ];
  "Unbreaking/smtp-password.age".publicKeys = [ Unbreaking ];

  "Unbreaking/nextcloud-admin-password.age".publicKeys = [ Unbreaking ];
  "Unbreaking/nextcloud-morgan-password.age".publicKeys = [ Unbreaking ];
